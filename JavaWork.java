...
class ConstDemo {
    public ConstDemo() {
        System.out.println("this is a constractor demonstration");
...
/*
 * method overloading:this is a way of naming a method with the same name but
 * with differrent argumebnts because it does different things
 * we can acces parents(super) class's elements with child's instance but never
 * to access child's methods with parent class's instance
 */
...
/*
 * Inheritance:this is a way in which a class is derivered from another one
 * which they share some properties;
 ...
 * a child class can access public and protected elements of a parent class not
 * private ones
 */
...
class InheritanceDemo {
    ...
    private void BwiraPrivate() {
        System.out
                .println("this is an error, it is never going tobe accessed by a child classes because it is private");
    }
}
...
/*
 * method overridding: this is the ability of overtaking superclasses'(parent
 * class) methods over child class, it is implemented in inheritance.
 * it gives the ability to choose which method to run, either one from parent
 * class or from child class depending on pririor of what we want
 * it's a simple implementation of polymorphism in OOP.
 * 'super' keyword is used to override a superclasses' methiods.
 * we can never override a constractor because it two classes can't have the
 * same name in the same program since a constractor must have tha same name as
 * class's.
 */
...
class JavaWork {
    public static void main(String[] args) {
        ...
        System.out.println("\n\nExample About a constractor");
        System.out.println("================================ ");
        ConstDemo ConstObj = new ConstDemo();
        ConstDemo ConstObj1 = new ConstDemo(20, 34);

        // inherritance demonstrations
        System.out.println("\n\n Example About inherritance ");
        System.out.println("================================");
        ChildClass inObj = new ChildClass();
        // now use child class to access parent methods(elements:
        // variables,methods,arrays, stacks, lists etc...);
        inObj.BwiraPublic();
        inObj.BwiraProtected();
        // inObj.BwiraPrivate(); //if you uncomment this it is never going to run.
        // becouse it is a private
        // method to the class InheritanceDemo and we're trying to access it with a
        // child class object

        // overloading demonstration
        System.out.println("\n\n Example About Overrloding Method ");
        System.out.println("====================================");

        overloadingDemo ovlobj = new overloadingDemo();
        ovlobj.AddNumbers(70, 40, 90);
        ovlobj.AddNumbers(50, 25);

        System.out.println(" \n\n Example About Overridding Method");
        ...
        ovrObj1.show();
        // ovrObj1.showAgain();//this is an error (if un commented) becouse we are
        // trying to access a ,ethod which we haven't overriden.
